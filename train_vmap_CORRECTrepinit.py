...
if __name__ == "__main__":
    ...
    if SAVE_ARRAY and len(hparams) == 3:
        ...
        with open(f"./plotting/{architecture}/CORRECTrepinit/{env_name}_CORRECTrepinit.npy", 'wb') as f:
            np.save(f, result["avg_returns"][..., save_indices])
        with open(f"./plotting/{architecture}/CORRECTrepinit/{env_name}_CORRECTrepinit_exps.npy", 'wb') as f:
