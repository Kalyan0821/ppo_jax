...
if __name__ == "__main__":
    ...
    if SAVE_ARRAY and len(hparams) == 3:
        ...
        with open(f"./plotting/{architecture}/CORRECTfixed_rep/{env_name}_CORRECTfixed_rep_plainb.npy", 'wb') as f:
            np.save(f, result["avg_returns"][..., save_indices])
        with open(f"./plotting/{architecture}/CORRECTfixed_rep/{env_name}_CORRECTfixed_rep_plainb_exps.npy", 'wb') as f:
